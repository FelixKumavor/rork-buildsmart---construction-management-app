...
export default function DashboardScreen() {
  ...
  const stats = [
    { id: 1, title: "Active Projects", value: "12", icon: FolderOpen, color: "#1E40AF" },
    { id: 2, title: "Tasks Due Today", value: "8", icon: Clock, color: "#F97316" },
    { id: 3, title: "Team Members", value: "24", icon: Users, color: "#16A34A" },
    { id: 4, title: "Budget Used", value: "68%", icon: DollarSign, color: "#DC2626" },
  ];
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsContainer}>
          {stats.map((stat) => (
            <TouchableOpacity key={stat.id} style={[styles.statCard, { width: (width - 60) / 2 }]}>
